...
export default class FormsRoutes {
    ...
    public getInstance(
        ...
        const params = readOnly ? { read_only: "true" } : undefined;
        return XenquAPI.Base.makeGet("/jform/instance/" + instanceId, params);
    }

    public listDefinitions(): Promise<any> {
        return XenquAPI.Base.makeGet("/jform/definitions/");
    }

    public getDefinition(definitionId: string): Promise<any> {
        return XenquAPI.Base.makeGet(`/jform/definition/${definitionId}`);
    }

    public getDefinitionDetails(definitionId: string): Promise<any> {
        return XenquAPI.Base.makeGet(
            `/jform/definition/${definitionId}/details/`
        );
    }

    public getDefinitionBuild(definitionId: string): Promise<any> {
        return XenquAPI.Base.makeGet(`/jform/definition/${definitionId}/build`);
    }

    public getInstanceDetails(instanceId: string): Promise<any> {
        return XenquAPI.Base.makeGet(`/jform/instance/${instanceId}/details/`);
    }

    public getInstanceAbout(instanceId: string): Promise<any> {
        return XenquAPI.Base.makeGet(`/jform/instance/${instanceId}/about/`);
    }

    public getInstanceDataHistory(instanceId: string): Promise<any> {
        return XenquAPI.Base.makeGet(
            `/jform/instance/${instanceId}/data/history/`
        );
    }
    ...
    public lockForm(
        ...
        return XenquAPI.Base.makePut(
            "/jform/instance/" + instanceId,
    ...
    public updateField(
        ...
        pageId: string,
        stateId: string,
        field: { raw_value: string; fid: string }
    ): Promise<any> {
        return XenquAPI.Base.makePut(
            `/jform/instance/${instanceId}/page/${pageId}/field/${stateId}`,
    ...
    public generatePDF(
        instanceId: string,
        pdfProperties: GeneratePDFOptions
    ): Promise<any> {
        // The slash at the end is IMPORTANT!
        return XenquAPI.Base.makePost(
            `/jform/instance/${instanceId}/pdf/`,
            JSON.stringify(pdfProperties)
        );
    }
    ...
    public getFile(instanceId: string, fileId: string): Promise<any> {
        return XenquAPI.Base.makeGet(
            `/jform/instance/${instanceId}/file/${fileId}`
        );
    }
}
